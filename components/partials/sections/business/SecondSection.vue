<template>
  <section class="w-full pt-36  lg:pt-28  pb-28 space-y-28 ">
    <div class="w-full space-y-24 max-w-[63.1875rem] mx-auto">
      <div class="w-full space-y-4">
        ...
        >
          ...
          ipsum morbi arcu turpis congue ullamcorper in. Lorem <br class=" hidden md:block" />
          ipsum dolor sit amet consectetur. Habitant vitae mauris <br class=" hidden md:block" />
          aliquam sapien habitant vitae. Egestas dignissim ipsum <br class=" hidden md:block" />
          morbi arcu turpis congue ullamcorper in.
        </p>
      </div>
    ...
    <div class="w-full bg-caribbean-green rounded-[3.125rem] px-4 py-20">
      <div
