    ...
    <header class="w-full  fixed top-0 left-0 z-50">
        <div class="w-full max-w-[80rem] mx-auto relative flex md:h-[4.75rem] items-center">
            <nav class="w-full h-full bg-white py-2 md:py-0 space-y-5 md:space-y-0 px-8 flex md:flex-row flex-col items-center md:justify-between z-50 rounded-b-[2.5rem] shadow-[0_4px_4px_0_rgba(0,0,0,0.05)]">
                ...
                <button @click="showMenu =!showMenu" class=" flex  justify-center items-center px-6 py-[0.625rem]  border  rounded-full 
                ...
                <button class="bg-caribbean-green hidden md:flex justify-center items-center px-6 py-[0.625rem] text-port-gore rounded-full 
                    tracking-[0.32px] uppercase transition-colors duration-300 ease-in-out
                ...
                <div v-if="showMenu" class="z-40 absolute top-0 left-0 w-full pt-[4.75rem] bg-port-gore text-white rounded-b-[2.5rem] 
                    ...
                    <div class="w-full max-w-[63.25rem] mx-auto py-20 grid sm:grid-cols-2 md:grid-cols-3 p-4 max-h-[488px] overflow-y-auto">
                        <div class="flex flex-col space-y-5 md:space-y-3">
                            <h3 class="md:mb-9 mb-5 text-3xl md:leading-10">MODULE</h3>
                        ...
                        <div class="flex flex-col  space-y-5 md:space-y-3 pt-10 sm:pt-0">
                            <h3 class="md:mb-9 mb-5  text-3xl md:leading-10">VERTRIEB</h3>
                        ...
                        <div class="flex flex-col  space-y-5 md:space-y-3 pt-10 md:pt-0">
                            <h3 class="md:mb-9 mb-5 text-3xl md:leading-10">UNTERNEHMEN</h3>
